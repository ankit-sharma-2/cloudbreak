...
public class TemplatePreparationObject {
    ...
    private final Optional<CustomConfigsView> customConfigsView;
    ...
    private TemplatePreparationObject(Builder builder) {
        ...
        customConfigsView = builder.customConfigsView;
    ...
    public Optional<CustomConfigsView> getCustomConfigs() {
    ...
    public static class Builder {
        ...
        private Optional<CustomConfigsView> customConfigsView = Optional.empty();
        ...
        public Builder withCustomConfigs(CustomConfigsView customConfigsView) {
            this.customConfigsView = Optional.ofNullable(customConfigsView);
            return this;
        }
