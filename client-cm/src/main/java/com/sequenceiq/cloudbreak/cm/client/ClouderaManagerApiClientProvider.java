...
public class ClouderaManagerApiClientProvider {
    ...
    public static final String API_V_44 = API_ROOT + "/v44";
    ...
    public ApiClient getV44Client(Integer gatewayPort, String user, String password, HttpClientConfig clientConfig) throws ClouderaManagerClientInitException {
        return getApiClientByApiVersion(gatewayPort, user, password, clientConfig, API_V_44);
    }
