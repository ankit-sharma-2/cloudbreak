...
public class CustomConfigPropertyParameters {
    ...
    @ApiModelProperty(value = ModelDescriptions.CustomConfigsModelDescription.NAME)
    @NotNull
    private String name;

    @ApiModelProperty(value = ModelDescriptions.CustomConfigsModelDescription.VALUE)
    @NotNull
