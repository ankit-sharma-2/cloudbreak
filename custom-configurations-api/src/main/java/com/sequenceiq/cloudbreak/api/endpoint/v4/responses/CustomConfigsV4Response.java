...
public class CustomConfigsV4Response {
    ...
    @ApiModelProperty(value = CustomConfigsModelDescription.CUSTOM_CONFIGURATIONS_NAME)
    @NotNull
    ...
    @ApiModelProperty(value = CustomConfigsModelDescription.CONFIGURATION_PROPERTIES)
    @NotNull
    private Set<CustomConfigPropertyParameters> configurations;

    @ApiModelProperty(value = CustomConfigsModelDescription.RUNTIME_VERSION)
